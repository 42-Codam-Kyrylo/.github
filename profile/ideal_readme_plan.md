...
## 👋 About Me & The 42 Pedagogy

I am a software engineering student at **Codam (42 Network)**. The 42 curriculum is unique: it has **no teachers, no classes, and no rigid schedule**. 
Instead, it relies entirely on **peer-to-peer learning** and rigorous **project-based evaluations**. 

Through this program, I have developed:
- 🧩 **First-principles thinking** by rewriting standard libraries (C) from scratch.
- 🤝 **Strong collaboration skills** through constant peer code reviews and team projects.
- 🚀 **Autonomy and resilience** by solving complex technical challenges independently.
...
|---------|------------|-------------|
| <a href="https://github.com/42-Codam-Kyrylo/ft_transcendence" target="_blank">**ft_transcendence**</a> | `Full-stack`, `WebSockets`, `Docker` | A full-stack, real-time web application featuring multi-user support, authentication, and selectable modules (e.g., real-time games, chat). |
| <a href="https://github.com/42-Codam-Kyrylo/Agent-Smith" target="_blank">**Agent Smith**</a> | `AI/LLMs`, `Python`, `Sandboxing` | An autonomous agentic framework that solves coding challenges by reasoning, generating code, and interacting with tools in a secure environment. |
...
<details open>
<summary><b>Milestone 0 & 1: Foundations & Algorithms</b> (Completed ✅)</summary>
<br>
...
<details>
<summary><b>Milestone 2: OOP & System Admin</b> (Completed ✅)</summary>
<br>
...
<details>
<summary><b>Milestone 4, 5 & 6: Advanced Architecture</b> (Upcoming ⏳)</summary>
<br>
